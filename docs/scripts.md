...
| `fm-claude-stop-autoarm.sh` | Claude Stop `asyncRewake` hook owning watcher continuity with demand-gated six-hour lease renewal with single-flight exit-2 rewake (docs/watcher-continuity.md) |
