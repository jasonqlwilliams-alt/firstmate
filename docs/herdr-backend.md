...
That headless launch replaces the launcher shell, redirects standard streams, and closes other inherited file descriptors so a caller's output capture can finish once the server reports running.
