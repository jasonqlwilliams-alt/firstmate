...
config/packet-router-inbox  optional path to this home's Packet Router inbox/new directory for halt-progress URGENT-ALERT packets; LOCAL, gitignored, and not inherited; absent means no packet is written; see docs/configuration.md "Packet Router inbox"
