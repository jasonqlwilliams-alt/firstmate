...
# liveness beacon (state/.last-watcher-beat) mtime is fresh within FM_GUARD_GRACE
# (the single source of truth, shared with fm-watch.sh and fm-guard.sh; content
# is informational), and prints
